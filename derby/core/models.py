...
class AwardTypes(models.Model):
    awardtypeid = models.AutoField(
        db_column="AwardTypeID", primary_key=True
...
class Awards(models.Model):
    id = models.AutoField(
        db_column="AwardID", primary_key=True
    )  # Field name made lowercase.
    name = models.TextField(db_column="AwardName")  # Field name made lowercase.
    award_type = models.ForeignKey(
        AwardTypes, models.DO_NOTHING, db_column="AwardTypeID"
    )
    class_id = models.IntegerField(
        db_column="ClassID", blank=True, null=True
    )  # Field name made lowercase.
...
class RaceCrew(models.Model):
    ...
    positionid = models.ForeignKey(
        CrewPositions, models.DO_NOTHING, db_column="PositionID", blank=True, null=True
    )
    customfield = models.TextField(
        db_column="CustomField", blank=True, null=True
    )  # Field name made lowercase.
    printed = models.TextField(
        db_column="Printed"
    )  # Field name made lowercase. This field type is a guess.
    imagefile = models.TextField(
        db_column="ImageFile", blank=True, null=True
    )  # Field name made lowercase.
...
class RaceInfo(models.Model):
    raceinfoid = models.AutoField(
        db_column="RaceInfoID", primary_key=True
    )  # Field name made lowercase.
...
class RegistrationInfo(models.Model):
    ...
    passedinspection = models.IntegerField(
        db_column="PassedInspection", blank=True, null=False, default=1
    )
    imagefile = models.TextField(
        db_column="ImageFile", blank=True, null=False, default=""
    )
    exclude = models.IntegerField(
        db_column="Exclude", blank=True, null=False, default=0
    )
    printed = models.IntegerField(
        db_column="Printed", blank=True, null=False, default=0
    )
...
class Roster(models.Model):
    ...
    finalist = models.IntegerField(
        db_column="Finalist", blank=True, null=False, default=0
    )
    grandfinalist = models.IntegerField(
        db_column="GrandFinalist", blank=True, null=False, default=0
    )
...
class Rounds(models.Model):
    id = models.AutoField(
        db_column="RoundID", primary_key=True
    )  # Field name made lowercase.
    round = models.IntegerField(db_column="Round")  # Field name made lowercase.
    classid = models.ForeignKey(
        Classes, models.DO_NOTHING, db_column="ClassID"
    )  # Field name made lowercase.
    charttype = models.IntegerField(
        db_column="ChartType", blank=True, null=True
    )  # Field name made lowercase.
...
class RaceChart(models.Model):
    resultid = models.AutoField(
        db_column="ResultID", primary_key=True
    )  # Field name made lowercase.
    classid = models.ForeignKey(
        Classes, models.DO_NOTHING, db_column="ClassID"
    )  # Field name made lowercase.
    ...
    ignoretime = models.IntegerField(
        db_column="IgnoreTime", blank=True, null=False, default=0
    )
    masterheat = models.IntegerField(
        db_column="MasterHeat", blank=True, null=False, default=0
    )
...
class StandingsGroup(models.Model):
    standingsid = models.AutoField(
        db_column="StandingsID", primary_key=True
    )  # Field name made lowercase.
    finishplacefinal = models.IntegerField(
        db_column="FinishPlaceFinal"
    )  # Field name made lowercase.
    finishplace = models.IntegerField(
        db_column="FinishPlace"
    )  # Field name made lowercase.
    time = models.FloatField(
        db_column="Time", blank=True, null=True
    )  # Field name made lowercase.
    points = models.IntegerField(
        db_column="Points", blank=True, null=True
    )  # Field name made lowercase.
    ...
    finishedallheats = models.BooleanField(
        db_column="FinishedAllHeats"
    )  # Field name made lowercase.
    tiebreakercode = models.TextField(
        db_column="TieBreakerCode", blank=True, null=True
    )  # Field name made lowercase.
